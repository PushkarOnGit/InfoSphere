...
class _ExamTimetableScreenState extends State<ExamTimetableScreen> {
  ...
  Future<void> _loadTimetables() async {
    final QuerySnapshot snapshot = await _firestore.collection('exam_timetables').get();
    setState(() {
  ...
  Future<void> _uploadTimetable() async {
    ...
    if (result != null) {
      ...
      final Reference storageRef = _storage.ref().child('exam_timetables/$fileName');
      ...
      await _firestore.collection('exam_timetables').add({
        'fileName': fileName,
